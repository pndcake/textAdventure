...
public class Game {
	...
	//methods for different player screens
	...
	public void talkGaurd() {
		...
		position = "talkGaurd";
		mainTextArea.setText("Gaurd: Hello Stranger. I'm sorry but we cannot let you into our town.");
	...
	public class ChoiceHandler implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			// switch statement for every different position. Activate buttons here by assigning method to each one
			switch(position) {
			case "townGate":
				switch(yourChoice) {
				case "c1": talkGaurd();
